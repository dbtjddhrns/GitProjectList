...
namespace CommBACNetDNET
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //{
            //    MessageBox.Show("EngineClient 프로그램을 실행 시켜 주세요", "확인");
            //    Application.Exit();
            //}
            //else
            {
                ...
                if (createdAsNew)
                {
                    ...
                    PjtBuilder = new ConfigMgr(g_currentdirectory + "\\" + "WooriSI.xml");

                    // wooriSI.xml 에서 프로젝트 정보를 읽어온다.
                    ...
                    //fClient.WindowState = FormWindowState.Minimized;
                    Application.Run(fClient);
                }
                else
                {
                    //MessageBox.Show("프로그램이 이미 실행 중 입니다.", "확인");
